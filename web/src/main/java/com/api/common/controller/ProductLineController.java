...
public class ProductLineController extends BaseController{
    ...
    */
     ...
     * @return: void
     */
    @RequestMapping(value = "addForWeb",method = RequestMethod.POST)
    @ResponseBody
    public void addForWeb(@RequestBody ProductLineAddVO productLineAddVO) throws Exception{
        this.productLineService.addForWeb(productLineAddVO);
    }

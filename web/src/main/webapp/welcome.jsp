        ...
        <%--$(function () {--%>
            ...
            <%--$('#list').grid({--%>
                ...
                <%--column: [{--%>
                    ...
                    <%--name: '',--%>
                    <%--format: function (r) {--%>
                        <%--&lt;%&ndash;if (r.toolAlarmType == "0") {//库存异常报警&ndash;%&gt;--%>
                            <%--&lt;%&ndash;return '<span class="ui-grid-tdtx"style="color:red">${session.lang.InventoryAlarmText}</span>';&ndash;%&gt;--%>
                        <%--&lt;%&ndash;} else if (r.toolAlarmType == "1") {//在途异常报警&ndash;%&gt;--%>
                            <%--&lt;%&ndash;return '<span class="ui-grid-tdtx"style="color:red">${session.lang.TransitPlanningAlarmText}</span>';&ndash;%&gt;--%>

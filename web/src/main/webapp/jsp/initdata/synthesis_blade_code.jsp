...
//            ary_li.push($('<li><a href="javascript:void(0)">删除</a></li>').click(function(){if(r.isDel == 0){del(r)}}));
        ...
        function search(){
            ...
            $.ajax({
                type: "POST",
                url: "/synthesisBladeCode/listForGroup",
                dataType: "json",
                ...
                success: function (data, textStatus) {
                    ...
                    data.data.forEach(function(d){
                        d.sname = d.synthesisCuttingTool.synthesisCode;
                    });
    ...
    <form id="partsEditForm" name="partsEditForm" method="post">
        ...
        <table class="m-frmtb" width="100%">
            <tr>
                ...
                <td>
                    <input name="synthesisCode" id="synthesisCode" type="text" class="u-ipt" maxlength="50">
                </td>
                <th width="150">
                    最大值
                </th>
                <td>
                    <input name="maxValue" id="maxValue" type="text" class="u-ipt" maxlength="50">
                </td>
            </tr>
            <tr>
                <th width="150">
                ...
                <td>
                    <input name="minValue" id="minValue" type="text" class="u-ipt" maxlength="50">
                </td>
            </tr>
        </table>
    </form>

        ...
        $(function(){
            ...
            $('#list').grid({
                ...
                column:[
                    ...
                    {
                        title:'待换装数量',
                        name:'toExchangeCount',
                        format : function(r){
                            return '<span class="ui-grid-tdtx">'+numberformat(r.toExchangeCount)+'</span>';
                        }
                    },
                    {
                        title:'待厂内刃磨数量',
                    ...
                    {
                        title:'待厂外刃磨数量',
                        name:'forGrindingOutCount',
                        format : function(r){
                            return '<span class="ui-grid-tdtx">'+numberformat(r.forGrindingOutCount)+'</span>';
                        }
                    },
                    {
                        title:'待回厂',
                        name:'grindingOutCount',
                        format : function(r){
                            return '<span class="ui-grid-tdtx">'+numberformat(r.grindingOutCount)+'</span>';
                        }
                    },
                    {
                        title:'报废',
                        name:'scrapCount',
                        format : function(r){
                            return '<span class="ui-grid-tdtx">'+numberformat(r.scrapCount)+'</span>';
                        }
                    }
                ],
                success:function(d){

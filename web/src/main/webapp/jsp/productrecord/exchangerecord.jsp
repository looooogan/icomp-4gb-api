...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#list').grid({
                ...
                column:[
                    ...
                    {
                        title:'安上时间',
                        name:'operatorInstallTime'
                    },
                    {
                        title:'安上人',
                        name:'operatorInstallName'
                    },
                    {
                        title:'卸下时间',
                        name:'operatorUninstallTime'
                    },
                    {
                        title:'卸下人姓名',
                        name:'operatorUninstallName'
                    },
                    {
                        title:'卸下原因',
                        name:'reason'
        ...
        function search(){
            ...
            $.ajax({
                type: "POST",
                url: "/synthesisCuttingToolBindleRecords/list",
                dataType: "json",
                ...
                success: function (data, textStatus) {
                    ...
                    data.data.forEach(function(d){
                        d.assemblylineName = d.productLineAssemblyline.name;
                        d.processName = d.productLineProcess.name;
                        d.equipmentName = d.productLineEquipment.name;
                        d.axleName = d.productLineAxle.name;
                        d.partsName = d.productLineParts.name;
                    })

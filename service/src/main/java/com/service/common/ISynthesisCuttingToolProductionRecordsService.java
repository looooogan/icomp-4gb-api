...
/**
*
* @ClassName ISynthesisCuttingToolProductionRecordsService
* @Description SynthesisCuttingToolProductionRecords业务接口
* @author Jivoin
*/
public interface ISynthesisCuttingToolProductionRecordsService {

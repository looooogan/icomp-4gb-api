...
/**
*
* @ClassName ISynthesisCuttingToolConfigService
* @Description SynthesisCuttingToolConfig业务接口
* @author Jivoin
*/
public interface ISynthesisCuttingToolConfigService {
    ...
    */
    ...
    /**
     * @Title: searchAndLocations
     * @Description: 根据查询条件查询 关联查询
     * @param synthesisCuttingToolConfigVO 查询条件封装
     * @throws Exception
     * @return: 查询结果
     */
